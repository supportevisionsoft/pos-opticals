...
Public Class LoginForm
    ...
    Private Sub txtPassword_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPassword.LostFocus
        Try
            ...
            If Not ds.Tables("Table").Rows.Count > 0 Then
                ...
                End If
            Else
                stQuery = "SELECT USER_PASSWD FROM MENU_USER WHERE USER_ID = '" & txtUserName.Text & "' AND USER_PASSWD ='" & txtPassword.Text & "'"
                ds = db.SelectFromTableODBC(stQuery)
                If Not ds.Tables("Table").Rows.Count > 0 Then
                    If Not txtPassword.Text = "" Then
                        txtPassword.Text = ""
    ...
    Private Sub butLogin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butLogin.Click
        Try
            ...
            stQuery = "select USER_ID from menu_user where USER_ID ='" & txtUserName.Text & "' and USER_PASSWD = '" & txtPassword.Text & "'"
            ...
            Else
                ...
                '    Exit Sub
                'End If
                stQuery = "select USER_ID from menu_user where USER_ID ='" & txtUserName.Text & "' and USER_PASSWD = '" & txtPassword.Text & "' and '" & Location_Code & "' in (SELECT ula_locn_code from user_location_access where ula_u_id = '" & txtUserName.Text & "' and ULA_PRIV_YN = 'Y')"
