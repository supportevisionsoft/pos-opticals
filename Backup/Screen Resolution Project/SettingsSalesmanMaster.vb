        ...
        Try
            If settingsType = "Salesman Master" Then
                ...
                Else
                    ...
                    pnlSalesmanAdd.Height = lblSalesmanSNo.Height + lstviewSalesmanMaster.Height + 1
                    pnlSalesmanAdd.BringToFront()
                    'Dim i As Integer = pnlSalesmanAdd.Height
                    'While i >= lblSalesmanSNo.Location.Y
                    'pnlSalesmanAdd.Location = New Point(lblSalesmanSNo.Location.X, i)
                    ...
                    If lstviewSalesmanMaster.SelectedItems.Item(0).SubItems(5).Text = "1" Then
                        ...
                        chkboxSalesmanAddFreeze.Enabled = False
                    Else
                        chkboxSalesmanAddFreeze.CheckState = CheckState.Unchecked
                    End If
        ...
        Try
            ...
            Else
                ...
                Else
                    Freeze = 2
                End If
                stQuery = "UPDATE OM_POS_SALESMAN_COUNTER SET SMC_LOCN_CODE='" & txtSMAddLcnCodeEdit.Text & "',SMC_COUNT_CODE='" & txtSMAddCountCodeEdit.Text & "',SMC_FRZ_FLAG_NUM='" & Freeze & "',SMC_UPD_DT=to_date(sysdate,'DD-MM-YY'),SMC_UPD_UID='" & LogonUser & "' WHERE SMC_CODE='" & txtSalesmanAddSMCode.Text & "' "
    ...
    Private Sub callEditCompany()
        If lstviewSalesmanMasterCMPY.SelectedItems.Count > 0 Then
            ...
            If lstviewSalesmanMasterCMPY.SelectedItems.Item(0).SubItems(3).Text = "1" Then
                ...
                chkSMCompEditFreeze.Enabled = False
            Else
        ...
        Try
            If lstviewSMMasterCOUNT.SelectedItems.Count > 0 Then
                ...
                If lstviewSMMasterCOUNT.SelectedItems.Item(0).SubItems(5).Text = "1" Then
                    ...
                    txtSMEditCountFz.Enabled = False
                Else
        ...
        Try
            If lstviewSMMasterSHIFT.SelectedItems.Count > 0 Then
                ...
                If lstviewSMMasterSHIFT.SelectedItems.Item(0).SubItems(5).Text = "1" Then
                    ...
                    chkSMEditShiftFz.Enabled = False
                Else
        ...
        Try
            ...
            Else
                ...
                Else
                    Freeze = 2
                End If
                stQuery = "UPDATE OM_POS_SALESMAN_SHIFT SET SMS_LOCN_CODE='" & txtSMAddShiftLcnCodeEdit.Text & "',SMS_SHIFT_CODE='" & txtSMAddShiftCodeEdit.Text & "',SMS_FRZ_FLAG_NUM='" & Freeze & "',SMS_UPD_DT=to_date(sysdate,'DD-MM-YY'),SMS_UPD_UID='" & LogonUser & "' WHERE SMS_CODE='" & txtSalesmanAddSMCode.Text & "' "
