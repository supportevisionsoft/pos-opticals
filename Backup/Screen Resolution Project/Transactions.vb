...
Public Class Transactions
    ...
    Dim PC_CAL_Year As String = 2013
            ...
            Try
                If SOHNO = 0 Then
                    ...
                    While success < 1
                        ...
                        Try
                            stQuery = "UPDATE OM_TXN_DOC_RANGE SET TXND_CURR_NO =" & TXN_CURR_NO + 1 & " WHERE TXND_COMP_CODE = '" & CompanyCode & "' AND TXND_TXN_CODE = '" & TXN_Code & "' AND TXND_LOCN_CODE = '" & Location_Code & "'"
                            errLog.WriteToErrorLog("U[date succ query", stQuery, "")
                            db.SaveToTableODBC(stQuery)
    ...
    Private Sub loadReport()
        Try
            ...
            ElseIf TXN_Code = "SO" Then
                ...
                errLog.WriteToErrorLog("Balancechk Query", stBalanceQuery, "")
                    ...
                    If count > 0 Then
                        ...
                        For k = 1 To txtItemCode.Count
                            ...
                            If dsI.Tables("Table").Rows.Count > 0 Then
                                ...
                                stQuery = stQuery & maxItemSYSID & "," & maxSYS_ID & "," & rowI.Item(0).ToString & ",'" & rowI.Item(2).ToString & "','" & dsIN.Tables("Table").Rows.Item(0).Item(0).ToString() & "','" & rowI.Item(4).ToString & "','" & rowI.Item(5).ToString & "'," & ItmQtyFound(0).Text & ",0," & ItmQtyFound(0).Text & ",0,0," & rowI.Item(6).ToString & ",0,0," & Convert.ToDouble(ItmQtyFound(0).Text) * Convert.ToDouble(ItmPriceFound(0).Text) & "," & Convert.ToDouble(ItmQtyFound(0).Text) * Convert.ToDouble(ItmPriceFound(0).Text) & ",'Y','" & Location_Code & "','" & Location_Code & "','" & txtSalesmanCode.Text & "','" & rowI.Item(7).ToString & "','" & rowI.Item(8).ToString & "','" & rowI.Item(2).ToString & "','','','" & LogonUser & "',current_timestamp)"
            ...
            Using connection As New OdbcConnection(db.GetConnectionString(""))
                ...
                Try
                    ...
                    If ds.Tables("Table").Rows.Count > 0 Then
                        ...
                        headRows(25) = row.Item(104).ToString
        ...
        Try
            ...
            For i = 0 To lstviewSOSelected.Items.Count - 1
                ...
                While count > 0
                    ...
                    totalAmount = totalAmount + Convert.ToDouble(row.Item(6).ToString) + Convert.ToDouble(row.Item(7).ToString)
    ...
    Private Shared Sub RenderLogo(ByVal bw As BinaryWriter)
        ...
        Dim displayString As String = ESC + "@"
        displayString = displayString + Chr(&HD) + ESC + Chr(&H45) + "1" + ESC + Chr(&H61) + "1" + "ALJABER OPTICALS"
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + Chr(&HD) + ESC + Chr(&H45) + "1" + ESC + Chr(&H61) + "1" + printdataset.Tables("Table").Rows.Item(0).Item(3).ToString 'locnname
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + ESC + Chr(&H61) + "1" + printdataset.Tables("Table").Rows.Item(0).Item(4).ToString 'locnaddr
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + ESC + Chr(&H61) + "1" + "Phone: " + printdataset.Tables("Table").Rows.Item(0).Item(5).ToString 'locnphone
        displayString = displayString + AsciiControlChars.Newline
        ...
        If transtype = "Sales Return" Then
            displayString = displayString + ESC + Chr(&H61) + "1" + "SALES RETURN"
        ElseIf transtype = "Direct Invoice" Then
            displayString = displayString + ESC + Chr(&H61) + "1" + "INVOICE" 'transtype
        ElseIf transtype = "Sales Order" Then
            displayString = displayString + ESC + Chr(&H61) + "1" + "SALES ORDER" 'transtype
        Else
            displayString = displayString + ESC + Chr(&H61) + "1" + "SALES Invoice" 'transtype
        End If
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + ESC + "@" + "Inv. No: " + printdataset.Tables("Table").Rows.Item(0).Item(1).ToString + "        " + "Date: " + printdataset.Tables("Table").Rows.Item(0).Item(2).ToString
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + "Salesman: " + printdataset.Tables("Table").Rows.Item(0).Item(20).ToString
        displayString = displayString + AsciiControlChars.Newline
        'displayString = displayString + "_________________________________________"
        displayString = displayString + "_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _"
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + "Product ID  Product Name      Qty   Price "
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + "_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ "
        ...
        bw.Write(ESC + "@" + "_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _")
        bw.Write(AsciiControlChars.Newline)
        
        Dim totDiscAmt As Double = totDiscountamt + Convert.ToDouble(printdataset.Tables("Table").Rows.Item(0).Item(18))

        FieldValue = String.Format("{0:0.00}", Convert.ToDecimal(totDiscountamt).ToString("0.00"))
        MsgBox(FieldValue)
        If totDiscAmt > 0 Then
            bw.Write(ESC + "@" + "Discount Total" & FieldValue.PadLeft(26, " "))
        ...
        'Added expenses by K.N 
        FieldValue = String.Format("{0:0.00}", (totExpenseamt).ToString("0.00"))
        MsgBox(FieldValue)
        ' bw.Write(ESC + "@" + "_________________________________________")
        bw.Write(ESC + "@" + "Expense Amount" & FieldValue.PadLeft(26, " "))
        bw.Write(AsciiControlChars.Newline)
        bw.Write(ESC + "@" + "_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _")
        bw.Write(AsciiControlChars.Newline)
        'Amount calculation
        FieldValue = String.Format("{0:0.00}", ((subValtotalamt - totDiscountamt) + totExpenseamt).ToString("0.00"))
        MsgBox(FieldValue)
        ...
        displayString = ESC + "@" + Chr(&HD) + ESC + Chr(&H45) + "1" + ESC + Chr(&H61) + "1" + "THANK YOU VISITING ALJABER"
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + ESC + Chr(&H61) + "1" + "PLEASE VISIT AGAIN"
        bw.Write(displayString)
        bw.Write(AsciiControlChars.Newline)
        displayString = ESC + "@" + Chr(&HD) + ESC + Chr(&H61) + "1" + "Warning: Choking hazard;"
        displayString = displayString + AsciiControlChars.Newline
        displayString = displayString + ESC + Chr(&H61) + "1" + "small parts, not suitable for"
        displayString = displayString + AsciiControlChars.Newline
    ...
    ' ''        'Dim oInvImage As Bitmap = New Bitmap(My.Resources.clientbilllogo)
    ...
    ' ''        If transtype = "Sales Return" Then
    ' ''            FieldValue = "SRTN.No : " & lastSR
    ' ''        Else
    ' ''            FieldValue = "Inv.No : " & lastDInv
    ' ''        End If
    ...
    ' ''        CurrentX = leftMargin - 100
    ' ''        CurrentY = CurrentY + InvoiceFontHeight + 3
    ' ''        FieldValue = "Totalin page doc Amount"
    ' ''        e.Graphics.DrawString(FieldValue, InvoiceFont, BlackBrush, CurrentX, CurrentY)
    ' ''        '()
    ...
    Private Shared Sub Print(ByVal printerName As String, ByVal document As Byte())
        Dim documentInfo As NativeMethods.DOC_INFO_1
        Dim printerHandle As IntPtr

        documentInfo = New NativeMethods.DOC_INFO_1()
        documentInfo.pDataType = "RAW"
        documentInfo.pDocName = "POS Joptics - From Location: " & Location_Code
    ...
    Public Sub TransactionSlipCallPrint()
        'MsgBox("TransactionSlipCallPrint")
    ...
    Private Sub pnl1Patient_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles pnl1Patient.Paint
