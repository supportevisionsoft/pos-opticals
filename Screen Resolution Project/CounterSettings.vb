...
Public Class CounterSettings
    ...
    Private Sub btnCtrSettEditUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCtrSettEditUpdate.Click
        ...
        If Not txtCrtSettEditWL1.Text.Length > 0 Then
            txtCrtSettEditWL1.Text = " "
        End If
        stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & txtCtrSettEditLocCode.Text & "' and  POCS_COUNTER_CODE= '" & txtCtrSettEditCntrCode.Text & "' and POCS_KEY='LINE_DISP_WL_1'"
        errLog.WriteToErrorLog("select", stQuery, "")
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            ...
            db.SaveToTableODBC(stQuery)
        Else
            stQuery = "insert into OM_POS_OPTIONS_COUNTER_SETUP (POCS_COMP_CODE,POCS_LOCN_CODE,POCS_COUNTER_CODE,POCS_KEY,POCS_VALUE,POCS_CR_UID,POCS_CR_DT) values('" & CompanyCode & "','" & txtCtrSettEditLocCode.Text & "','" & txtCtrSettEditCntrCode.Text & "','LINE_DISP_WL_1','" & txtCrtSettEditWL1.Text.Replace("'", "''") & "','" & LogonUser & "',sysdate)"
            errLog.WriteToErrorLog("Insert Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        End If
        
        If Not txtCrtSettEditWL2.Text.Length > 0 Then
            txtCrtSettEditWL2.Text = " "
        End If
        stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & txtCtrSettEditLocCode.Text & "' and  POCS_COUNTER_CODE= '" & txtCtrSettEditCntrCode.Text & "' and POCS_KEY='LINE_DISP_WL_2'"
        errLog.WriteToErrorLog("select", stQuery, "")
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            ...
            db.SaveToTableODBC(stQuery)
        Else
            stQuery = "insert into OM_POS_OPTIONS_COUNTER_SETUP (POCS_COMP_CODE,POCS_LOCN_CODE,POCS_COUNTER_CODE,POCS_KEY,POCS_VALUE,POCS_CR_UID,POCS_CR_DT) values('" & CompanyCode & "','" & txtCtrSettEditLocCode.Text & "','" & txtCtrSettEditCntrCode.Text & "','LINE_DISP_WL_2','" & txtCrtSettEditWL2.Text.Replace("'", "''") & "','" & LogonUser & "',sysdate)"
            errLog.WriteToErrorLog("Insert Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        End If

        If Not txtCrtSettEditTL1.Text.Length > 0 Then
            txtCrtSettEditTL1.Text = " "
        End If
        stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & txtCtrSettEditLocCode.Text & "' and  POCS_COUNTER_CODE= '" & txtCtrSettEditCntrCode.Text & "' and POCS_KEY='LINE_DISP_TL_1'"
        errLog.WriteToErrorLog("select", stQuery, "")
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            ...
            db.SaveToTableODBC(stQuery)
        Else
            stQuery = "insert into OM_POS_OPTIONS_COUNTER_SETUP (POCS_COMP_CODE,POCS_LOCN_CODE,POCS_COUNTER_CODE,POCS_KEY,POCS_VALUE,POCS_CR_UID,POCS_CR_DT) values('" & CompanyCode & "','" & txtCtrSettEditLocCode.Text & "','" & txtCtrSettEditCntrCode.Text & "','LINE_DISP_TL_1','" & txtCrtSettEditTL1.Text.Replace("'", "''") & "','" & LogonUser & "',sysdate)"
            errLog.WriteToErrorLog("Insert Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        End If

        If Not txtCrtSettEditTL2.Text.Length > 0 Then
            txtCrtSettEditTL2.Text = " "
        End If
        stQuery = "select POCS_VALUE from OM_POS_OPTIONS_COUNTER_SETUP where POCS_LOCN_CODE= '" & txtCtrSettEditLocCode.Text & "' and  POCS_COUNTER_CODE= '" & txtCtrSettEditCntrCode.Text & "' and POCS_KEY='LINE_DISP_TL_2'"
        errLog.WriteToErrorLog("select", stQuery, "")
        ds = db.SelectFromTableODBC(stQuery)
        If ds.Tables("Table").Rows.Count > 0 Then
            ...
            db.SaveToTableODBC(stQuery)
        Else
            stQuery = "insert into OM_POS_OPTIONS_COUNTER_SETUP (POCS_COMP_CODE,POCS_LOCN_CODE,POCS_COUNTER_CODE,POCS_KEY,POCS_VALUE,POCS_CR_UID,POCS_CR_DT) values('" & CompanyCode & "','" & txtCtrSettEditLocCode.Text & "','" & txtCtrSettEditCntrCode.Text & "','LINE_DISP_TL_2','" & txtCrtSettEditTL2.Text.Replace("'", "''") & "','" & LogonUser & "',sysdate)"
            errLog.WriteToErrorLog("Insert Query OM_POS_OPTIONS_LOCATION_SETUP", stQuery, "")
            db.SaveToTableODBC(stQuery)
        End If
