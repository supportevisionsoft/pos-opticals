...
Public Class frmStockReport
    ...
    Public Sub stocklist()
        Try
            ...
            stQuery = "SELECT POCS_KEY, POCS_VALUE FROM OM_POS_OPTIONS_COUNTER_SETUP WHERE POCS_COMP_CODE = '" + CompanyCode + "' AND POCS_LOCN_CODE = '" + strArrLocfrom(0) + "' AND POCS_KEY='PL_CODE'"
